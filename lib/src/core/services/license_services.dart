...
class LicenseServices {
  final String _key = "oakqGiacopoTeujlblLHfuH1iCu9BruH5qvmGbvRUYsxfZ88LCBvNSJYJu4hxuHMNs8JkILPgFYtainx7MlwRr5FAQQz7JcLQ3h8SRlxICJzEQJQdPWgAYkqTvqZfr3QWQ";

  Future<String?> getDeviceId() async {
    final box = await Hive.openBox('device_key');
    if (box.get('id') == null) {
      var uuid = Uuid();
      final id = "${uuid.v1()}${uuid.v4()}";
      await box.put('id', id);
